              ...
              <div class="with-sidebar-content twelve columns">
                 <div class="gdlr-item gdlr-item-start-content" id="gdlr-single-booking-content" data-ajax="https://demo.goodlayers.com/hotelmaster/dark/wp-admin/admin-ajax.php">
                      ...
                      <div class="gdlr-reservation-bar-summary-form gdlr-active" id="gdlr-reservation-bar-summary-form" style="display: block;">
                         <div class="gdlr-price-summary-wrapper">
                            ...
                            <div class="gdlr-price-room-summary">
                               ...
                               <div class="gdlr-price-room-summary-info gdlr-title-font"><span>Người lớn : 2</span><span>Trẻ em : 0</span><span class="gdlr-price-room-summary-price" href="#">$90.00</span></div>
                            </div>
                            ...
                            <div class="gdlr-price-deposit-wrapper">
                               <div class="gdlr-price-deposit-input">
                                <span class="gdlr-active">
                                  <label class="gdlr-radio-input">
                                    <input type="radio" name="pay_deposit" value="false" checked="">
                                  </label>
                                  Thanh toán toàn bộ
                                </span>
                                <span>
                                  <label class="gdlr-radio-input">
                                    <input type="radio" name="pay_deposit" value="true">
                                  </label>
                   ...
                   <div class="gdlr-booking-content">
                    <div class="gdlr-booking-content">
                      <div class="gdlr-booking-process-bar" id="gdlr-booking-process-bar" data-state="3">
                         ...
                         <div data-process="3" class="gdlr-booking-process gdlr-active">3. Đặt phòng</div>
                      ...
                      <div class="gdlr-booking-content-wrapper">
                         <div class="gdlr-booking-content-inner" id="gdlr-booking-content-inner" style="opacity: 1; height: auto;">
                            <div class="gdlr-booking-contact-container">
                               <form class="gdlr-booking-contact-form" method="post" data-ajax="https://demo.goodlayers.com/hotelmaster/dark/wp-admin/admin-ajax.php">
                                  ...
                                  <a href="{{route('choose4')}}" class="gdlr-button with-border gdlr-booking-contact-submit">
                                    Đặt ngay bây giờ qua email và chúng tôi sẽ liên hệ lại với bạn.</a>
                                  <div class="gdlr-booking-contact-or">
                                     Or
                                     <div class="gdlr-booking-contact-or-divider gdlr-left"></div>
                                     <div class="gdlr-booking-contact-or-divider gdlr-right"></div>
                                  </div>
                                  <div class="gdlr-payment-method"><label class="gdlr-active"><input type="radio" name="payment-method" value="paypal" checked=""><img src="https://demo.goodlayers.com/hotelmaster/dark/wp-content/plugins/gdlr-hotel/include/../images/paypal.png" alt=""></label><label><input type="radio" name="payment-method" value="stripe"><img src="https://demo.goodlayers.com/hotelmaster/dark/wp-content/plugins/gdlr-hotel/include/../images/stripe.png" alt=""></label><label><input type="radio" name="payment-method" value="authorize"><img src="https://demo.goodlayers.com/hotelmaster/dark/wp-content/plugins/gdlr-hotel/include/../images/authorize.png" alt=""></label></div>
                                  <a href="#" class="gdlr-button with-border gdlr-booking-payment-submit">Thanh toán ngay</a>	
                                </form>
                             </div>
                          </div>
                       </div>
